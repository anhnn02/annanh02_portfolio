        ...
        <>
            <div className="tw-mt-24 tw-px-10">
                <div className="tw-text-center tw-mb-10">
                    <h2 className="tw-font-bold tw-text-2xl md:tw-text-3xl">Ann’<span className="tw-text-2xl md:tw-text-3xl tw-text-thirty">s</span> Concepts </h2>
                </div>
                <div className="">
                    ...
                    <div className="tw-grid tw-mt-10 tw-gap-6 sm:tw-grid-cols-2 md:tw-gap-8 md lg:tw-grid-cols-3 lg:tw-gap-20">
                        <div className="tw-bg-white tw-bg-opacity0 tw-rounded-lg tw-fx tw-flex-col tw-justify-between tw-items-c tw-text-center tw-p-6">
                            <Link to="">
                            ...
                            <div className="tw-flex tw-justify-between tw-items-center tw-mt-3">
                                <h3 className="tw-my-2"><Link to="" className="tw-text-bgr">Courses IFT</Link></h3>
                                <div className="tw-tooltip" data-tip="Link">
                                    <Link to="">
                                        <img src="https://i.imgur.com/Hmoonmc.png"
                                            className="tw-inline-block tw-bg-bgr tw-w-10 tw-h-10 tw-object-cover tw-rounded-full tw-p-1" alt="" />
                                    </Link>
                                </div>
                            </div>
                        </div>
