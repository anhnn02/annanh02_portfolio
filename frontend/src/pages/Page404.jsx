...
const Page404 = () => {
    return (
        <div className="container-page404 bg-purple">
            <div className="stars">
                ...
                <div className="central-body">
                    ...
                    <Link to="http://salehriaz.com/404Page/404.html" className="btn-go-home" target="_blank" rel="noreferrer">GO BACK HOME</Link>
                </div>
